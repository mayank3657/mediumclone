      ...
      <Link to={`/story/${data?._id}`}>
        <div className="stories">
          <div className="stories-top">
            ...
            <p>
              Hello Coding Aliens, How are you doing guys? Welcome back to
              another blog. But this time something interesting and unique...
            </p>
            <div className="footer">
              <span>
                Published on {moment(data?.created_at).format("MMM DD YYYY")} ·
                3 min read
              </span>
              <Tooltip title="Share">
                <span>
